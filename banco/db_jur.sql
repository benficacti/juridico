...
--
-- Host: 127.0.0.1
-- Generation Time: 04-Abr-2019 às 13:04
...
(83, 225805, 'BENFICA BARUERI TRANSPORTE E TURISMO', 'BENFICA BARUERI TRANSPORTE E TURISMO', NULL, 4, 50, 5, 0, 5, '2019-03-13', 0, '2019-03-12', '2019-03-15', '2019-03-25', 8, NULL, 1, NULL, 1, 1, 2),
(86, 85693654, 'BENFICA BARUERI TRANSPORTE E TURISMO', 'BENFICA BBTT', NULL, 6, 0, 5, 0, 5, '2019-04-05', 0, '2019-03-11', '1997-03-20', '2020-01-05', 12, NULL, 1, NULL, 1, 1, 4),
(87, 16545615, 'ashkdhjkas', 'jkashdjkash', NULL, NULL, 0, 10, 0, 5, '2019-03-13', 0, '2019-03-11', '2019-03-16', '2019-03-21', NULL, NULL, 1, NULL, 1, NULL, NULL),
(88, 0, '', '', NULL, NULL, 0, 0, 0, 0, '0000-00-00', 0, '0000-00-00', '0000-00-00', '0000-00-00', NULL, NULL, 1, NULL, 1, NULL, NULL),
(89, 0, '', '', NULL, NULL, 0, 0, 0, 0, '0000-00-00', 0, '0000-00-00', '0000-00-00', '0000-00-00', NULL, NULL, 1, NULL, 1, NULL, NULL);
...
CREATE TABLE `garantia` (
  ...
  `DESC_GARANTIA` varchar(45) NOT NULL,
...
--
ALTER TABLE `contrato`
  MODIFY `ID_CONTRATO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
...
--
ALTER TABLE `objeto`
  MODIFY `ID_OBJETO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `observacoes_exigencias`
--
ALTER TABLE `observacoes_exigencias`
  MODIFY `ID_OBSERVACOES_EXIGENCIAS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
